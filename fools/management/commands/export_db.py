...
Examples
    ...
    python manage.py export_db --apps fools,auth --indent 2 -o backups/backup.json.gz
"""
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            "--apps",
            help="Comma-separated app labels to export (e.g. 'auth,fools'). If omitted exports all apps.",
            default=None,
        )
        parser.add_argument(
            "--exclude",
